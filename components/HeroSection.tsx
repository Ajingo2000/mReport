...
import backImage from "@/public/images/whitesquare.png";
...
export const HeroSection = () => {
  return (
    <section className="relative overflow-hidden py-20 lg:py-28 mt-16 isolate">
      ...
      <div className="container mx-auto px-4 lg:px-8 flex items-center justify-center min-h-[500px]">
        <div className="text-center max-w-4xl">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-white/95 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
              mReport empowers citizens to report broken GBV and urgent SRHR health needs
